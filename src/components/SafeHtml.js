...
import Cite from './CiteRenderer/index.js';
 ...
 */
export default function SafeHtml({ value, as: Component = 'div', makeLinksExternal = 'auto', relAttribute = 'noopener noreferrer', replaceFn = null, onReady = null, ...rest }) {
    ...
    if (Array.isArray(value)) value = value.map((v) => `<p style="color:inherit">${v}</p>`).join('');
